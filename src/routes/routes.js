...
const { getGames, resetGameHistory } = require("../controllers/metrics/MetricsController");
...
router.delete("/api/metrics/game/:gameId/history", requireAuth, resetGameHistory);
router.get(
...
router.get(
  "/api/metrics/texas-holdem/net-profit-per-hand",
  requireAuth,
  getNetProfitPerHand,
);
router.get(
